...
SWITCH_DECLARE(switch_odbc_status_t) switch_odbc_handle_callback_multi_row_exec_detailed(const char *file, const char *func, int line, switch_odbc_handle_t *handle,
		                                         const char *sql, switch_core_db_callback_func_t callback, void *pdata,
							                                          char **err);
...
#define switch_odbc_handle_callback_multi_row_exec(handle,  sql,  callback, pdata, err) \
	    switch_odbc_handle_callback_multi_row_exec_detailed(__FILE__, (char * )__SWITCH_FUNC__, __LINE__, \
			                              handle, sql, callback, pdata, err)
